...
@NgModule({
    ...
    providers: [
        ApperyioRestService, ApperyioConfigService, EntityApiService, ApperyioHelperService, ApperyioMappingHelperService, ApperyioDataHelperService, ApperyioNativeHelperService, ApperyioPreloadHelperService, ApperyioThemeHelperService, ApperyioSocialLoginHelperService
        , ModalScreensService
    ]
})
