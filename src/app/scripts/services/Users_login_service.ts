/**
 * Module initializes rest service Users_login_service
 */
import {
    Injectable
} from '@angular/core';
...
class Users_login_service {
    ...
    execute(reqOpts ? : any) {
        ...
        let config = {
            ...
            method: "post",
            headers: this.entityAPI.get("Users_login_service.request.headers", reqOpts.headers),
            params: this.entityAPI.get("Users_login_service.request.query", reqOpts.params),
            data: this.entityAPI.get("Users_login_service.request.body", reqOpts.data, true, true) || "",
            aio_config: {
                requestType: "json",
                responseType: "json",
                serviceName: "Users_login_service"
            }
        };
...
*/
export {
    Users_login_service as ExportedClass
};