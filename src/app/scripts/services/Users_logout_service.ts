/**
 * Module initializes rest service Users_logout_service
 */
import {
    Injectable
} from '@angular/core';
...
class Users_logout_service {
    ...
    execute(reqOpts ? : any) {
        ...
        let config = {
            ...
            method: "get",
            headers: this.entityAPI.get("Users_logout_service.request.headers", reqOpts.headers),
            params: this.entityAPI.get("Users_logout_service.request.query", reqOpts.params),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "Users_logout_service"
            }
        };
...
*/
export {
    Users_logout_service as ExportedClass
};