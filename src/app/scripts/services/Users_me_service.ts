/**
 * Module initializes rest service Users_me_service
 */
import {
    Injectable
} from '@angular/core';
...
class Users_me_service {
    ...
    execute(reqOpts ? : any) {
        ...
        let config = {
            ...
            method: "get",
            headers: this.entityAPI.get("Users_me_service.request.headers", reqOpts.headers),
            params: this.entityAPI.get("Users_me_service.request.query", reqOpts.params),
            aio_config: {
                requestType: "",
                responseType: "json",
                serviceName: "Users_me_service"
            }
        };
...
*/
export {
    Users_me_service as ExportedClass
};